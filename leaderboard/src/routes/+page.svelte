...
<div class="container mx-auto py-8 px-4">
  <div class="mb-8">
    <h1 class="text-4xl font-bold mb-2">MRM Instance Leaderboard</h1>
    <p class="text-muted-foreground">Track and compare market making bot performance</p>
  </div>
  
  <!-- Summary Stats -->
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
    <div class="p-4 rounded-lg border bg-card">
      <div class="text-sm text-muted-foreground">Active Instances</div>
      <div class="text-2xl font-bold">{activeInstances}</div>
    </div>
    <div class="p-4 rounded-lg border bg-card">
      <div class="text-sm text-muted-foreground">Average APY</div>
      <div class="text-2xl font-bold">
        {avgAPY.toFixed(2)}%
      </div>
    </div>
    <div class="p-4 rounded-lg border bg-card">
      <div class="text-sm text-muted-foreground">Total Volume</div>
      <div class="text-2xl font-bold">
